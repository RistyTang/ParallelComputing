...
__m256i column_nums = _mm256_set1_epi32(Column_Nums);
__m256i one = _mm256_set1_epi32(1);
__m256i bits_per_word = _mm256_set1_epi32(32);
__m256i Eliminated_Bit_Size;
    ...
    for(int i=0;i<Eliminated_Line_Nums;i++)
    {
        ...
        {  
            ...
            {    
                ...
                {
                    __m256i byte1 = _mm256_load_si256(&Elimination_Line[i].Eliminated_Bytes[j]);
                    __m256i byte2 = _mm256_load_si256(&Eliminer[CurFirstOne].Eliminated_Bytes[j]);
                    byte1 = _mm256_xor_si256(byte1, byte2);
                    _mm256_store_si256(&Elimination_Line[i].Eliminated_Bytes[j], byte1);
...
int main()
{
    Eliminated_Bit_Size = _mm256_add_epi32(_mm256_sub_epi32(column_nums, one), bits_per_word);
    Eliminated_Bit_Size = _mm256_srli_epi32(Eliminated_Bit_Size, 5);
    ReadData();
